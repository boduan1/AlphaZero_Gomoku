        ...
        try:
            for i in range(self.game_batch_num):
                ...
                if (i+1) % self.check_freq == 0:
                    ...
                    self.policy_value_net1.save_model('./current_b_policy3.model')
                    self.policy_value_net2.save_model('./current_w_policy3.model')
                    if win_ratio > self.best_win_ratio:
                        print("New best policy!!!!!!!!")
                        self.best_win_ratio = win_ratio
                        # update the best_policy
                        self.policy_value_net1.save_model('./best_b_policy3.model')
                        self.policy_value_net2.save_model('./best_w_policy3.model')
